...
printf 'sdk.dir=%s\n' "$SDK">"$ROOT/local.properties";cd "$ROOT";./gradlew --no-daemon --stacktrace assembleDebug;cp -f app/build/outputs/apk/debug/app-debug.apk RemoteLink-v0.3-alpha-debug.apk
echo "APK: $ROOT/RemoteLink-v0.3-alpha-debug.apk"
